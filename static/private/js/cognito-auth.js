/*global WebApp _config AmazonCognitoIdentity AWSCognito*/
...
(function scopeWrapper($) {
    ...
    WebApp.signOut = function signOut() {
        userPool.getCurrentUser().signOut();
    };

    WebApp.authToken = new Promise(function fetchCurrentAuthToken(resolve, reject) {
